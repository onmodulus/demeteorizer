...
Demeteorizer.prototype.createPackageJSON = function (context, callback) {
  ...
  var arbJson = JSON.parse(context.options.arbJson);
  ...
  fs.writeFileSync(context.paths.package_json, JSON.stringify(packageJSON, JSON.stringify(packageJSON.arbitrary), 2));
